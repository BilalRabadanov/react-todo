...
function App() {
  ...
  // const onEditTask = (listId, taskObj) => {
  //   const newTaskText = window.prompt("На что поменять?", taskObj.text)
  ...
  //   })
  //   setLists(newList)
  //   axios.patch("http://localhost:3001/tasks/" + taskObj.id, { text: taskObj.text })
  //     .catch(() => { alert("Не удалось отловить название списка") })
  // }
